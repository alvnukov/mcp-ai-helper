...
func Schema() map[string]any {
	return map[string]any{
		...
		"fields": []FieldDoc{
			...
			{Path: "integrations.jira.allowed_repositories", Type: "[]string", Default: "empty (all repositories)", Description: "Global-only absolute path allowlist for local repositories that may see Jira tools. Paths may start with ~; descendants are included. A non-empty list fails closed when startup repository context is unknown. Tool visibility changes after MCP restart."},
			...
			{Path: "integrations.confluence.allowed_repositories", Type: "[]string", Default: "empty (all repositories)", Description: "Global-only absolute path allowlist for local repositories that may see Confluence tools. Paths may start with ~; descendants are included. A non-empty list fails closed when startup repository context is unknown. Tool visibility changes after MCP restart."},
