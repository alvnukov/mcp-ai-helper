...
func Schema() map[string]any {
	return map[string]any{
		...
		"fields": []FieldDoc{
			...
			{Path: "web_policy.enabled", Type: "bool", Default: "true", Description: "Enables bounded web_fetch/fetch_url network access. Disable to fail closed."},
			...
			{Path: "web_policy.allowed_schemes", Type: "[]string", Default: "https,http", Description: "Allowed URL schemes for web_fetch/fetch_url."},
			...
			{Path: "web_policy.user_agent", Type: "string", Default: "mcp-ai-helper/0.1", Description: "User-Agent used for web_fetch/fetch_url requests."},
			{Path: "web_policy.search_provider", Type: "string", Description: "Default explicit web_search provider. Empty keeps web_search fail-closed unless the call passes provider. Supported: duckduckgo_html.", Examples: []string{"duckduckgo_html"}},
