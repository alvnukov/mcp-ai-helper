...
func Schema() map[string]any {
	return map[string]any{
		...
		"fields": []FieldDoc{
			...
			{Path: "task_registry.backend", Type: "string", Default: "lean", Description: "Task registry backend selection. Empty or lean keeps the Lean/Lake registry; obsidian switches to markdown files under task_registry.obsidian.path. Any other value fails at startup.", Examples: []string{"lean", "obsidian"}},
